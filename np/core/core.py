...
def calculate_scale(_file, conf=None, scale=None):
	if conf == None:
		conf = readConf()
...
def init_window_position():
	write_log('core.py.init_window_position running from somewhere...', 'DEBUG')
	print ("core.py.init_window_position running from somewhere...")
	screen = conf['screen']
	windows = {}
	windows['viewer'] = {}
	windows['gui'] = {}
	...
	#print ("Viewer window:", viewer_win_x, viewer_win_y, viewer_win_w, viewer_win_h)
	gui_win_w = 1024
	gui_win_h = 600
	browser_win_w = 600
	browser_win_h = 150
