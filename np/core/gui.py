...
class gui():
	def __init__(self):
		...
		player_controls1 = [self.create_old('btn', ['previous']), self.create_old('btn', ['play']), self.create_old('btn', ['next']), self.create_old('btn', ['pause']), self.create_old('btn', ['stop'])]
		player_controls2 = [self.create_old('btn', ['rotate 90']), self.create_old('btn', ['seek fwd']), self.create_old('btn', ['seek rev']), self.create_old('btn', ['Exit'])]

		slider_scale = [self.create_old('slider', [(1, 100), scale, 'h', '-VIDEO_SCALE-'])]
		line_window_ctl = [self.create_old('btn', ['store window location']), self.create_old('btn', ['Hide UI']), self.create_old('btn', ['Recenter UI'])]
		...
		self.menu_def = [['&File', ['&Load', '&Save', 'E&xit']], ['&Toolbar', ['&Torrent Manager', 'Command &2', 'Command &3', 'Command &4']], ['&Help', '&About...']]
		...
		#self.conf['windows']['-GUI-'] = self.WINDOW
