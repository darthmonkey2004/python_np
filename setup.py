...
setup(name='np',
	...
	package_dir={'np': 'np', 'np.core': 'np/core', 'np.utils': 'np/utils', 'np.np': 'dist/np'},
	scripts=['install_np.sh', 'np/scripts/mkmedialist', 'np/scripts/np.remote', 'np/scripts/write_client_html', 'dist/np'],
